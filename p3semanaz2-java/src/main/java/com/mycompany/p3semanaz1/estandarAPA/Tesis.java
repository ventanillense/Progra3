...
public class Tesis extends Publicacion{
    ...
    public String toString(){
        ...
        referencia = referencia.concat(" [");
        if(null==clase) referencia.concat("No especificado");
        else switch (clase) {
            case Doctorado:
                referencia.concat("Tesis de Doctorado");
                break;
            case Maestria:
                referencia.concat("Tesis de Maestría");
                break;
            default:
                referencia.concat("Tesis de Licenciatura");
                break;
        }
        referencia = referencia.concat(", ");
