...
public class ConcreteFactoryIEEE implements AbstractFactoryPublicacion{
    @Override
    public Publicacion crearArticulo(String nombre, String nombre_completo_autor,
    ...
    @Override
    public Publicacion crearArticulo(String nombre, ArrayList<Autor> autores,
            Integer año, String revista, Integer volumen, Integer numero, String mes) {
        return new Articulo(nombre, autores, año, revista, volumen, numero, mes);
    }

    @Override
    public Publicacion crearLibro(String nombre, String nombre_completo_autor,
    ...
    @Override
    public Publicacion crearLibro(String nombre, ArrayList<Autor> autores,
            Integer año, String edicion, String lugar, String editorial) {
    ...
    @Override
    public Publicacion crearTesis(String nombre, ArrayList<Autor> autores,
